  ...
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8  ">
        ...
        Urlite simplifies URL shortening for efficient sharing. Easily
          generate, manage, and track your shortened links. Urlite simplifies
          URL shortening for efficient sharing. Easily generate, manage, and
          track your shortened links. Urlite simplifies URL shortening for
          efficient sharing. Easily generate, manage, and track your shortened
          links. Urlite simplifies URL shortening for efficient sharing.
