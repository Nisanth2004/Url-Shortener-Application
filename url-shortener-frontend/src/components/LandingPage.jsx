...
const LandingPage = () => {
  ...
  let desc =
  "Generate short, memorable links with ease using Urlite’s intuitive interface. Share URLs effortlessly across platforms. Optimize your sharing strategy with Urlite. Track clicks and manage your links seamlessly to enhance your online presence. Generate short, memorable links with ease using Urlite’s intuitive interface. Share URLs effortlessly across platforms.";
  ...
  return (
    ...
    <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
      ...
      <motion.h1
          ...
          >
            Urlite Simplifies URL Shortening For Efficient Sharing.
          </motion.h1>
      <p className="text-slate-700 text-sm my-5">
            Urlite streamlines the process of URL shortening, making sharing
            links effortless and efficient. With its user-friendly interface,
            Urlite allows you to generate concise, easy-to-share URLs in
            seconds. Simplify your sharing experience with Urlite today.
          </p>
