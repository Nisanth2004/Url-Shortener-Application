...
const LandingPage = () => {
  ...
  return (
    ...
    <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
      ...
      <h1 className='font-bold font-roboto text-slate-800 md:text-5xl text-3xl md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full'>  Linklytics Simplifies URL Shortening For Efficient Sharing.</h1>
